...
namespace Booking.Migrations
{
    ...
    [Migration("20250514151334_EnglishTranslationRenamed")]
    partial class EnglishTranslationRenamed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.Data.Entities.AccRates", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Booking.Data.Entities.RealtyGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Booking.Data.Entities.AccRates", b =>
                {
                    b.HasOne("Booking.Data.Entities.Realty", "Realty")
                        .WithOne("AccRates")
                        .HasForeignKey("Booking.Data.Entities.AccRates", "RealtyId")
            ...
            modelBuilder.Entity("Booking.Data.Entities.ItemImage", b =>
                {
                    ...
                    b.HasOne("Booking.Data.Entities.RealtyGroup", null)
                        .WithMany("Images")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Booking.Data.Entities.RealtyGroup", b =>
                {
                    b.HasOne("Booking.Data.Entities.RealtyGroup", "ParentGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Data.Entities.UserAccess", b =>
                {
                    b.HasOne("Booking.Data.Entities.UserRole", "UserRole")
                        .WithMany("UserAccesses")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Booking.Data.Entities.User", "User")
                        .WithMany("userAccesses")
