...
//            return monoRates
//                .Select(monoRates => new CurrencyRate
//                {
//                    FullName = iso4217[monoRates.currencyCodeA].FullName,
//                    ShortName = iso4217[monoRates.currencyCodeA].ShortName,
//                    RateBuy = monoRates.rateBuy ?? monoRates.rateCross ?? 0.0,
//                    RateSell = monoRates.rateSell ?? monoRates.rateCross ?? 0.0,
//                    Date = DateOnly.FromDateTime(DateTime.FromBinary(monoRates.date))
//                }).ToList();
//        }
...
//            {694, new CurrencyInfo("SL", "Sierra Leon") }
//        };
//    }
//}
